                           ...
                           <div class="pull-right"><!-- pull-right Begin -->
                               ...
                               <?php 
                                ...
                                if(!isset($_SESSION['customer_email'])){
                                    ...
                                    echo"<button class='btn btn-default'><a href='checkout.php' class=‘btn btn-primaary’>
                                    ...
                                    echo"<button class='btn btn-default'><a href='order.php?c_id=$customer_id;' class=‘btn btn-default’>
                                   
                                    <i class=‘fa fa-chevron-right’></i>Proceed Checkout

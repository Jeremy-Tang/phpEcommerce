               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="manufacturer" class="form-control"><!-- form-control Begin -->
                              ...
                              $get_manufacturer = "select * from shipping_status";
                              $run_manufacturer = mysqli_query($con,$get_manufacturer);
                              
                              while ($row_manufacturer=mysqli_fetch_array($run_manufacturer)){
                                  
                                  $manufacturer_id = $row_manufacturer['s_id'];
                                  $manufacturer_title = $row_manufacturer['s_title'];
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input pattern="[0-9]+.+[0-9]{2}" name="product_price" type="text" class="form-control" required value="<?php echo $p_price; ?>">
...
if(isset($_POST['update'])){
    ...
    if(is_uploaded_file($_FILES['file']['tmp_name'])){
        ...
        echo "<script>window.open('admin_menu.php?view_products','_self')</script>"; 

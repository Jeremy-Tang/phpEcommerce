                    ...
                    <div class="panel panel-primary"><!-- panel panel-primary begin -->
                        ...
                        <div class="panel-footer"><!-- panel-footer begin -->
                            <center><!-- center begin -->
                                ...
                                <a href="admin_menu.php?delete_box=<?php echo $box_id; ?>" class="pull-right"><!-- pull-right begin -->
                                
                                 <i class="fa fa-trash"></i> Delete
                                
                                </a><!-- pull-right finish -->
                                
                                <a href="admin_menu.php?edit_box=<?php echo $box_id; ?>" class="pull-left"><!-- pull-left begin -->

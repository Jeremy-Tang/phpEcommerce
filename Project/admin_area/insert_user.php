               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" name="admin_email" type="text" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input pattern=".{6,}" name="admin_pass" type="password" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input pattern="[A-Za-z]+" name="admin_country" type="text" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Contact (01xxxxxxxx) </label> 
                      
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          
                          <input pattern="[0-9]{10}" name="admin_contact" type="text" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input pattern="[A-Za-z]+" name="admin_job" type="text" class="form-control" required>
...
if(isset($_POST['submit'])){
    ...
    if($run_user){
        ...
        echo "<script>window.open('admin_menu.php?view_users','_self')</script>";

       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="../Home.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/logo1.png" alt="JY Store Logo" class="hidden-xs">
                   <img src="images/logo_mobile.png" alt="JY Store Logo Mobile" class="visible-xs">
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <form action="confirm.php?update_id=<?php echo $order_id;  ?>" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <input pattern="[0-9]+" type="text" class="form-control" name="invoice_no" required>
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> Amount Sent: </label>
                          ...
                          <input pattern="[0-9]+.+[0-9]{2}" type="text" class="form-control" name="amount_sent" required>
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> Transaction / Reference ID: </label>
                          ...
                          <input pattern="[0-9]+" type="text" class="form-control" name="ref_no" required>
                           
                       </div><!-- form-group Finish -->
                       
                       <div class="form-group"><!-- form-group Begin -->
                           
                         <label> Paypall / Payoneer / Tounch n Go Code: </label>
                          
                          <input pattern="[0-9]+" type="text" class="form-control" name="code" required>
                           
                       </div><!-- form-group Finish -->
                       
                       <div class="form-group"><!-- form-group Begin -->
                           
                         <label> Payment Date:(DD/MM/YY) </label>
                          
                          <input pattern="\d{1,2}/\d{1,2}/\d{4}" type="text" class="form-control" name="date" required>
